...
const notification_service_1 = require("./notifiers/notification.service");
...
const init = (app) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const notifier = new notification_service_1.Notifier(pusher);
    // Initialize the ingredient module
    const ingredientRepo = new ingredient_repository_1.IngredientRepository();
    const ingredientService = new ingredient_service_1.IngredientService(ingredientRepo, notifier);
    ...
    const platService = new plat_service_1.PlatService(platRepo, ingredientRepo, notifier, ingredientService);
