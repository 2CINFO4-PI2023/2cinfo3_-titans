...
export class Routes {
  ...
  init() {
    ...
    this.app.use("/reclamations",validateJwtToken,this.reclamationRouter.reclamationRoutes);
    this.app.use("/events", validateJwtToken,this.eventRouter.eventRoutes);
    this.app.use("/inscriptions",validateJwtToken, this.inscriptionRouter.inscriptionRoutes);
    this.app.use("/types",validateJwtToken, this.eventTypeRouter.eventTypeRoutes);
    this.app.use("/ingredient",validateJwtToken,this.ingredientRouter.ingredientRoutes)
